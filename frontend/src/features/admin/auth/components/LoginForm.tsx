...
export const LoginForm = () => {
  ...
  return (
    <div
      className={cn(
        'font-inter w-full rounded-2xl bg-white shadow-xl backdrop-blur-sm',
    ...
    >
      ...
      <div className="mb-6 text-center md:mb-8 lg:mb-9 xl:mb-16">
        <h1 className="text-3xl leading-tight font-normal text-gray-800 md:text-4xl lg:text-[42px] xl:text-[50px]">
          Welcome Back!
        </h1>
      </div>
      ...
      >
        ...
        >
                ...
                <Input
                  ...
                  className={
                    fieldState.invalid
                      ...
                      : 'h-12 w-full rounded-lg border border-gray-200 px-4 py-3 text-sm placeholder:text-sm focus:border-none focus:border-[#007DFC] focus:ring-2 focus:ring-[#007DFC] focus:outline-none md:h-12 md:px-4 md:py-3 md:text-sm placeholder:md:text-sm lg:h-13 lg:px-5 lg:py-3 lg:text-[13px] placeholder:lg:text-[13px] xl:h-16 xl:px-6 xl:py-5 xl:text-[14px] placeholder:xl:text-[14px]'
                  }
                />
                {fieldState.invalid && (
                  <FieldError
              ...
              <Field data-invalid={fieldState.invalid}>
                ...
                <Input
                  ...
                  className={
                    fieldState.invalid
                      ? 'h-12 w-full rounded-lg border border-red-500 px-4 py-3 text-sm placeholder:text-sm focus:border-red-500 focus:ring-2 focus:ring-red-500 focus:outline-none md:h-12 md:px-4 md:py-3 md:text-sm placeholder:md:text-sm lg:h-13 lg:px-5 lg:py-3 lg:text-[13px] placeholder:lg:text-[13px] xl:h-16 xl:px-6 xl:py-5 xl:text-[14px] placeholder:xl:text-[14px]'
                      : 'h-12 w-full rounded-lg border border-gray-200 px-4 py-3 text-sm placeholder:text-sm focus:border-[#007DFC] focus:ring-2 focus:ring-[#007DFC] focus:outline-none md:h-12 md:px-4 md:py-3 md:text-sm placeholder:md:text-sm lg:h-13 lg:px-5 lg:py-3 lg:text-[13px] placeholder:lg:text-[13px] xl:h-16 xl:px-6 xl:py-5 xl:text-[14px] placeholder:xl:text-[14px]'
                  }
                />
                {fieldState.invalid && (
                  <FieldError
          ...
          <div className="py-2 text-right lg:py-2 xl:py-2">
            <a
              href="#"
              className="text-xs text-gray-600 transition-colors hover:text-[#007DFC] md:text-sm lg:text-[13px] xl:text-[14px]"
            >
              Forgot Password?
            </a>
          </div>
          ...
          <div className="pt-3 md:pt-4 lg:pt-4 xl:pt-8">
            <Button
              className={cn(
                'w-full bg-[#007DFC] text-white hover:bg-[#0066d4]',
